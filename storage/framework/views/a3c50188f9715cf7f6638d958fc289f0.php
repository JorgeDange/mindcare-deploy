<?php $__env->startSection('content'); ?>
    ...
    <section class="hero-static">
        <img src="<?php echo e(asset('assets/TRIO III.jpg')); ?>" class="static-img" alt="Sobre">
    ...
    <section class="servicos-premium-section">
        ...
        <div class="sp-grid">
            ...
            <div class="sp-column">
                ...
                <a href="<?php echo e(url('/servicos')); ?>" class="sp-saiba-mais">Saiba mais <i
    ...
    <section class="quem-atendemos">
        ...
        <div class="lista">
            ...
            <div class="item">
                <div class="icon_c">
                    <img src="<?php echo e(asset('assets/social.png')); ?>" alt="">
                </div>
                <div class="texto">
                    <h3>Indivíduos</h3>
                    <p>
            ...
            <div class="item">
                <div class="icon_c">
                    <img src="<?php echo e(asset('assets/family.png')); ?>" alt="">
                </div>
                <div class="texto">
                    <h3>Famílias</h3>
                    <p>
            ...
            <div class="item">
                <div class="icon_c">
                    <img src="<?php echo e(asset('assets/comunity.png')); ?>" alt="">
                </div>
                <div class="texto">
            ...
            <div class="item">
                <div class="icon_c">
                    <img src="<?php echo e(asset('assets/enity.png')); ?>" alt="">
                </div>
                <div class="texto">
                    <h3>Organizações</h3>
                    <p>
        ...
        <div class="team-grid">
            ...
            <div class="team-card">
                <div class="team-img-wrapper">
                    <img src="<?php echo e(asset('assets/js.png')); ?>" alt="Joyceline Vatuva">
                </div>
                <div class="team-info">
            ...
            <div class="team-card">
                <div class="team-img-wrapper">
                    <img src="<?php echo e(asset('assets/pl.jpg')); ?>" alt="Priscilla Lima">
                </div>
                <div class="team-info">
            ...
            <div class="team-card">
                <div class="team-img-wrapper">
                    <img src="<?php echo e(asset('assets/sb.png')); ?>" alt="Isabel Fernandes">
                </div>
                <div class="team-info">
            ...
            <div class="team-card">
                <div class="team-img-wrapper">
                    <img src="<?php echo e(asset('assets/s.png')); ?>" alt="Ana Panzo">
                </div>
                <div class="team-info">
                    <h3>Ana Panzo</h3>
                    <p>Psicóloga Clínica</p>
            ...
            <div class="team-card">
                <div class="team-img-wrapper">
                    <img src="<?php echo e(asset('assets/cl (1).png')); ?>" alt="Francisco Cassule">
                </div>
                <div class="team-info">
            ...
            <div class="team-card">
                <div class="team-img-wrapper">
                    <img src="<?php echo e(asset('assets/cl (2).png')); ?>" alt="Teresa Paquice">
                </div>
                <div class="team-info">
        ...
        <div class="parceiros-grid">
            <div class="ticker-track">
                ...
                <div class="parceiro-card">
                    <img src="<?php echo e(asset('assets/parceiros (1).png')); ?>" alt="Anglobal">
                </div>
                <div class="parceiro-card">
                    <img src="<?php echo e(asset('assets/parceiros (2).png')); ?>" alt="Luele">
                </div>
                <div class="parceiro-card logo-dark">
                    <img src="<?php echo e(asset('assets/parceiros (3).png')); ?>" alt="LIS">
                </div>
                <div class="parceiro-card">
                    <img src="<?php echo e(asset('assets/parceiros (4).png')); ?>" alt="Aurora">
                </div>
                <div class="parceiro-card">
                    <img src="<?php echo e(asset('assets/parceiros (1).jpg')); ?>" alt="Lulo">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/sobre.blade.php ENDPATH**/ ?>