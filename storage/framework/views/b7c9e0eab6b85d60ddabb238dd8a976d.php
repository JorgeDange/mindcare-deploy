<?php $__env->startSection('title', 'Ficha Clínica — MindCare'); ?>

<?php $__env->startSection('content'); ?>
<form action="<?php echo e(route('portal.ficha.update')); ?>" method="POST" id="ficha-form" class="space-y-stack-lg">
    <?php echo csrf_field(); ?>
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-end gap-4 mb-stack-lg">
        <div>
            ...
            <h2 class="font-headline-lg text-headline-lg text-on-background"><?php echo e(Auth::user()->name); ?></h2>
        </div>
        <div class="flex flex-col sm:flex-row w-full md:w-auto gap-stack-sm">
            <a href="<?php echo e(route('dashboard')); ?>" class="w-full sm:w-auto px-6 h-[48px] border-2 border-outline text-on-surface rounded-lg font-bold flex items-center justify-center hover:bg-surface-variant transition-colors">Cancelar</a>
            ...
            <div class="bg-surface-container-lowest rounded-xl p-stack-md flex flex-col items-center shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
                <div class="relative mb-4">
                    <?php if(Auth::user()->foto_perfil): ?>
                        <img src="<?php echo e(asset('storage/' . Auth::user()->foto_perfil)); ?>" alt="Foto" class="w-32 h-32 rounded-full object-cover border-4 border-surface-container shadow-md">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('perfil')); ?>" class="absolute bottom-0 right-0 bg-primary text-on-primary w-10 h-10 rounded-full flex items-center justify-center shadow-lg">
                ...
                <p class="text-on-surface-variant text-body-sm">ID: #MC-<?php echo e(Auth::id()); ?></p>
            </div>
            ...
            <div class="bg-surface-container-lowest rounded-xl p-stack-md shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center p-3 rounded-lg bg-background hover:bg-surface-variant transition-colors cursor-pointer group">
                        ...
                        <span class="text-body-sm text-on-surface font-bold group-hover:text-primary"><?php echo e($ultConsulta ? \Carbon\Carbon::parse($ultConsulta->data)->format('d/m/Y') : 'N/A'); ?></span>
                    </div>
                    <div class="flex justify-between items-center p-3 rounded-lg bg-background hover:bg-surface-variant transition-colors cursor-pointer group">
                        <span class="text-body-sm font-medium text-on-surface-variant">Próxima Consulta</span>
                        <span class="text-body-sm text-primary font-bold"><?php echo e($proxConsulta ? \Carbon\Carbon::parse($proxConsulta->data)->format('d/m/Y') : 'N/A'); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-9 bg-surface-container-lowest rounded-xl p-stack-lg shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
            ...
            <div id="tab-info" class="tab-content active">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-bright focus:border-secondary outline-none transition-shadow text-body-md" type="text" name="name" value="<?php echo e(old('name', $paciente->user->name)); ?>" required />
                    </div>
                    
                    <!-- Email & BI -->
                    <div>
                        <label class="block font-body-sm font-bold text-on-surface mb-2">E-mail</label>
                        <input class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-container-low text-on-surface-variant cursor-not-allowed outline-none text-body-md" type="email" value="<?php echo e($paciente->user->email); ?>" disabled />
                    </div>
                    <div>
                        <label class="block font-body-sm font-bold text-on-surface mb-2">Número de BI / NIF</label>
                        <input class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-bright focus:border-secondary outline-none transition-shadow text-body-md" type="text" name="bi_numero" value="<?php echo e(old('bi_numero', $paciente->user->bi_numero)); ?>" />
                    </div>
                    
                    <!-- Phone & Date of Birth -->
                    <div>
                        <label class="block font-body-sm font-bold text-on-surface mb-2">Telefone</label>
                        <input class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-bright focus:border-secondary outline-none transition-shadow text-body-md" type="tel" name="telefone" value="<?php echo e(old('telefone', $paciente->user->telefone)); ?>" placeholder="+244 900 000 000" />
                    </div>
                    <div>
                        <label class="block font-body-sm font-bold text-on-surface mb-2">Data de Nascimento</label>
                        <input class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-bright focus:border-secondary outline-none transition-shadow text-body-md" type="date" name="data_nascimento" value="<?php echo e(old('data_nascimento', optional($paciente->user->data_nascimento)->format('Y-m-d'))); ?>" />
                    </div>
                    ...
                    <div>
                        ...
                        <select name="genero" class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-bright focus:border-secondary outline-none transition-shadow text-body-md">
                            ...
                            <option value="Masculino" <?php if(old('genero', $paciente->user->genero) === 'Masculino'): echo 'selected'; endif; ?>>Masculino</option>
                            <option value="Feminino" <?php if(old('genero', $paciente->user->genero) === 'Feminino'): echo 'selected'; endif; ?>>Feminino</option>
                            <option value="Outro" <?php if(old('genero', $paciente->user->genero) === 'Outro'): echo 'selected'; endif; ?>>Outro</option>
                        </select>
                    </div>
                    <div>
                        <label class="block font-body-sm font-bold text-on-surface mb-2">Província / Cidade</label>
                        <input class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-bright focus:border-secondary outline-none transition-shadow text-body-md" type="text" name="provincia" value="<?php echo e(old('provincia', $paciente->user->provincia)); ?>" />
                    </div>
                    
                    <!-- Address -->
                    <div class="md:col-span-2">
                        <label class="block font-body-sm font-bold text-on-surface mb-2">Endereço Residencial</label>
                        <input class="w-full h-12 px-4 rounded-lg border border-outline-variant bg-surface-bright focus:border-secondary outline-none transition-shadow text-body-md" type="text" name="morada" value="<?php echo e(old('morada', $paciente->user->morada)); ?>" />
                    </div>
                </div>
            </div>
            ...
            <div id="tab-clinica" class="tab-content hidden space-y-stack-lg">
                <header class="flex justify-between items-end border-b border-outline-variant/30 pb-stack-sm mb-stack-lg">
                    <div>
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant">Paciente: <?php echo e($paciente->user->name); ?></p>
                    </div>
                </header>
                    ...
                    <section class="col-span-12 md:col-span-7 bg-surface-container-lowest p-stack-lg rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
                        ...
                        <div class="space-y-stack-md">
                            <div>
                                ...
                                <textarea name="motivo_consulta" class="w-full bg-surface-bright border border-outline-variant rounded-lg p-4 font-body-md text-body-md focus:ring-2 focus:ring-secondary/20 focus:border-secondary outline-none transition-all" rows="2" placeholder="Descreva brevemente o motivo ou sintomas..."><?php echo e(old('motivo_consulta', $paciente->motivo_consulta)); ?></textarea>
                            </div>
                            <div>
                                <label class="font-bold text-on-surface block mb-2">Histórico Médico Prévio</label>
                                <textarea name="condicoes" class="w-full bg-surface-bright border border-outline-variant rounded-lg p-4 font-body-md text-body-md focus:ring-2 focus:ring-secondary/20 focus:border-secondary outline-none transition-all" rows="2" placeholder="Condições pré-existentes, alergias ou patologias..."><?php echo e(old('condicoes', $paciente->condicoes)); ?></textarea>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="col-span-12 md:col-span-5 bg-surface-container-lowest p-stack-lg rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
                        ...
                        <div class="space-y-stack-md">
                            <div>
                                ...
                                <textarea name="medicacao" class="w-full bg-surface-bright border border-outline-variant rounded-lg p-4 font-body-md text-body-md focus:ring-2 focus:ring-secondary/20 focus:border-secondary outline-none transition-all" rows="2" placeholder="Nome dos medicamentos, dosagens e frequências..."><?php echo e(old('medicacao', $paciente->medicacao)); ?></textarea>
                            </div>
                            <div>
                                <label class="font-bold text-on-surface block mb-2">Observações Adicionais</label>
                                <textarea name="observacoes" class="w-full bg-surface-bright border border-outline-variant rounded-lg p-4 font-body-md text-body-md focus:ring-2 focus:ring-secondary/20 focus:border-secondary outline-none transition-all" rows="2" placeholder="Outras notas ou informações..."><?php echo e(old('observacoes', $paciente->observacoes)); ?></textarea>
                            </div>
                        </div>
                    </section>
                </div>
            ...
            <div id="tab-hist" class="tab-content hidden">
                ...
                <div class="relative pl-8 md:pl-12 space-y-12">
                    <?php if($paciente->consultas->count() > 0): ?>
                    ...
                    <section>
                        <div class="grid grid-cols-1 gap-6">
                            <?php $__empty_1 = true; $__currentLoopData = $paciente->consultas->sortByDesc('data'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consulta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="group relative bg-surface-container-lowest p-stack-md rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.05)] border border-transparent hover:border-primary/20 transition-all duration-300">
                                    <div class="absolute -left-[31px] md:-left-[39px] top-1/2 -translate-y-1/2 w-4 h-4 rounded-full <?php echo e($consulta->estado === 'Realizada' ? 'bg-primary' : 'bg-surface-variant'); ?> border-4 border-surface group-hover:scale-125 transition-transform z-10"></div>
                                    <div class="flex gap-6 items-start">
                                        <div class="bg-surface-container-high p-4 rounded-xl flex flex-col items-center justify-center min-w-[80px]">
                                            <span class="font-label-md text-label-md text-primary font-bold uppercase"><?php echo e(\Carbon\Carbon::parse($consulta->data)->locale('pt')->isoFormat('ddd')); ?></span>
                                            <span class="font-headline-md text-headline-md text-on-surface"><?php echo e(\Carbon\Carbon::parse($consulta->data)->format('d')); ?></span>
                                        </div>
                                        <div class="flex-1">
                                            <div class="flex justify-between items-start mb-2">
                                                <div>
                                                    <span class="inline-block px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest mb-1 <?php echo e($consulta->estado === 'Realizada' ? 'bg-green-100 text-green-800' : 'bg-surface-variant text-on-surface-variant'); ?>"><?php echo e($consulta->estado); ?></span>
                                                    <h3 class="font-title-lg text-title-lg text-on-surface"><?php echo e($consulta->tipo); ?></h3>
                                                </div>
                                            </div>
                                            <div class="flex items-center gap-2 mb-3">
                                                <span class="material-symbols-outlined text-on-surface-variant text-[20px]">person</span>
                                                <p class="font-body-sm text-body-sm font-semibold"><?php echo e($consulta->profissional->user->name ?? 'Clínica'); ?></p>
                                                <span class="text-on-surface-variant text-body-sm">• <?php echo e($consulta->profissional->especialidade ?? 'Especialista'); ?></span>
                                            </div>
                                            <p class="font-body-md text-body-md text-on-surface-variant line-clamp-2">Modalidade: <?php echo e(ucfirst($consulta->modalidade)); ?></p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="tab-docs" class="tab-content hidden">
                ...
                <div class="bg-surface-container-lowest rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.05)] overflow-hidden">
                    ...
                    <div class="divide-y divide-surface-variant">
                        <?php $__empty_1 = true; $__currentLoopData = $paciente->documentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $documento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 px-stack-md py-4 items-center hover:bg-surface-container/30 transition-colors group cursor-pointer">
                                <div class="md:col-span-7 flex items-center gap-4">
                                    ...
                                    <div>
                                        <h4 class="font-body-md text-body-md font-semibold text-on-surface group-hover:text-primary transition-colors"><?php echo e($documento->nome); ?></h4>
                                ...
                                <div class="md:col-span-3 text-body-sm text-on-surface-variant">
                                    <?php echo e($documento->created_at->format('d de F, Y')); ?>

                                </div>
                                <div class="md:col-span-2 flex justify-end gap-2 md:opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="<?php echo e(route('portal.documento.download', $documento)); ?>" class="w-9 h-9 hover:bg-surface-container rounded-full flex items-center justify-center text-primary" title="Download">
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/portal/ficha.blade.php ENDPATH**/ ?>