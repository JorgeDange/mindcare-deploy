...
<section class="hero-static">
    <img src="<?php echo e(asset('assets/Consultoria2 - Cópia.jpg')); ?>" class="static-img" alt="Serviços">
    ...
    <div class="servicos-content-container animate-on-scroll">
        ...
        <div id="clinica" class="servicos-tab-pane active fade-up-on-scroll delay-600">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/Consultoria2 - Cópia.jpg')); ?>" alt="Atendimento Clínico">
            </div>
            <div class="servicos-content-info">
                ...
                <div class="servicos-actions">
                    <a href="<?php echo e(route('login')); ?>" class="btn-primary-sc">Agendar consulta</a>
                </div>
            </div>
        </div>
        ...
        <div id="formacao" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/TREINAMENTO IV (1).jpg')); ?>" alt="Formação">
            </div>
            <div class="servicos-content-info">
                ...
                <div class="servicos-actions">
                    <a href="<?php echo e(route('login')); ?>" class="btn-primary-sc">Saber mais</a>
                </div>
            </div>
        </div>
        ...
        <div id="consultoria" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/MIND_PCA VI.jpg')); ?>" alt="Consultoria">
            </div>
            <div class="servicos-content-info">
                ...
                <div class="servicos-actions">
                    <a href="<?php echo e(url('/sobre')); ?>" class="btn-primary-sc">Solicitar proposta</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="cta-bottom-section animate-on-scroll">
        <div class="cta-container fade-up-on-scroll">
            ...
            <div class="cta-actions">
                <a href="<?php echo e(route('login')); ?>" class="btn-primary-sc">Agendar consulta</a>
                <a href="<?php echo e(url('/planos')); ?>" class="btn-secondary-sc">Ver planos</a>
            </div>
        </div>
    </section>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/servicos.blade.php ENDPATH**/ ?>