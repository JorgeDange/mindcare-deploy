<?php $__env->startSection('title', 'Documentos — Profissional'); ?>
        ...
        <div class="flex items-center gap-3">
            <select id="filter-paciente" class="rounded-lg border border-outline-variant/50 px-3 py-2 text-body-sm focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none bg-white">
                ...
                <?php $__currentLoopData = $pacientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($p->id); ?>"><?php echo e($p->user?->name); ?></option>
                ...
                <tbody id="documentos-tbody">
                    <?php $__currentLoopData = $documentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="border-b border-outline-variant/20 hover:bg-surface-container-low transition-colors documento-row"
                            data-paciente="<?php echo e($doc->paciente_id); ?>"
                            data-categoria="<?php echo e($doc->categoria ?? ''); ?>">
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-body-sm font-medium text-on-surface"><?php echo e($doc->nome); ?></p>
                                        <?php if($doc->descricao): ?>
                                            <p class="text-xs text-on-surface-variant truncate max-w-[200px]"><?php echo e($doc->descricao); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="py-3 px-4 text-body-sm text-on-surface-variant"><?php echo e($doc->paciente?->user?->name ?? '—'); ?></td>
                            <td class="py-3 px-4">
                                <span class="font-label-md font-semibold px-2.5 py-1 rounded-full text-[11px] <?php echo e($catInfo[1]); ?>">
                                    <?php echo e($catInfo[0]); ?>

                                </span>
                            </td>
                            <td class="py-3 px-4 text-body-sm text-on-surface-variant whitespace-nowrap"><?php echo e($doc->created_at->format('d/m/Y')); ?></td>
                            <td class="py-3 px-4 text-body-sm text-on-surface-variant"><?php echo e($tamanhoFormatado); ?></td>
                            <td class="py-3 px-4">
                                <a href="<?php echo e(route('profissional.documentos.download', $doc)); ?>"
...
<div id="novo-documento-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <form method="POST" action="<?php echo e(route('profissional.documentos.store')); ?>" enctype="multipart/form-data" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.profissional', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/profissional/documentos/index.blade.php ENDPATH**/ ?>