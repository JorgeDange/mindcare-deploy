...
<section class="hero-new" id="default-carousel">
    <div class="carousel-wrapper">
        <!-- SLIDE 1 -->
        <div class="mc-slide">
            <img src="<?php echo e(asset('assets/Consultoria2 - Cópia.jpg')); ?>" class="carousel-img" alt="Slide 1">
            ...
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(url('/planos')); ?>" class="btn-solid-hero">Escolher o meu plano</a>
                    <a href="<?php echo e(url('/planos')); ?>" class="btn-ghost-hero">Conhecer os planos</a>
                </div>
        ...
        <!-- SLIDE 2 -->
        <div class="mc-slide">
            <img src="<?php echo e(asset('assets/SECRETARIA 2.jpg')); ?>" class="carousel-img" alt="Slide 2">
            <div class="hero-overlay-layer"></div>
            <div class="hero-content">
                <div class="badge-tag">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(url('/servicos')); ?>" class="btn-solid-hero">Marcar consulta</a>
                </div>
            </div>
        </div>
        <!-- SLIDE 3 -->
        <div class="mc-slide">
            <img src="<?php echo e(asset('assets/MIND_PCA VI.jpg')); ?>" class="carousel-img" alt="Slide 3">
            <div class="hero-overlay-layer"></div>
            <div class="hero-content">
                <div class="badge-tag">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(url('/planos')); ?>" class="btn-solid-hero">Planos corporativos</a>
                    <a href="<?php echo e(url('/sobre')); ?>" class="btn-ghost-hero">Falar connosco</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="plans-group">
            ...
            <div class="plans-cards-row">
                <div class="plan-card-premium">
                    ...
                    <a href="<?php echo e(route('planos.particular')); ?>" class="btn-join-new">Aderir agora</a>
                    <a href="<?php echo e(route('planos')); ?>" class="learn-more-link">saiba mais</a>
                </div>
                <div class="plan-card-premium">
                    <h3><span>Plano</span> Familia</h3>
                    <a href="<?php echo e(route('planos.familiar')); ?>" class="btn-join-new">Aderir agora</a>
                    <a href="<?php echo e(route('planos')); ?>" class="learn-more-link">saiba mais</a>
                </div>
            </div>
        </div>
        ...
        <div class="plans-group">
            ...
            <div class="plans-cards-row">
                <div class="plan-card-premium">
                    ...
                    <a href="<?php echo e(route('planos.corporativo')); ?>" class="btn-join-new">Aderir agora</a>
                    <a href="<?php echo e(route('planos')); ?>" class="learn-more-link">saiba mais</a>
                </div>
                <div class="plan-card-premium">
...
<section class="cta-final">
    <div class="cta-content">
        ...
        <div class="cta-buttons">
            <a href="<?php echo e(route('login')); ?>" class="btn-cta-primary">Aderir agora</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/welcome.blade.php ENDPATH**/ ?>