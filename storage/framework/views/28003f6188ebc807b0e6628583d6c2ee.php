...
<section class="hero-static">
    <img src="<?php echo e(asset('assets/Consultoria2 - Cópia.jpg')); ?>" class="static-img" alt="Planos">
    ...
    <div class="servicos-content-container animate-on-scroll">
        ...
        <div id="particular" class="servicos-tab-pane active fade-up-on-scroll delay-700">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano2.png')); ?>" alt="Plano Particular">
            </div>
            <div class="servicos-content-info">
                ...
                <div class="servicos-actions">
                    <a href="<?php echo e(route('planos.particular')); ?>" class="btn-primary-sc">Ver planos</a>
                </div>
            </div>
        </div>
        ...
        <div id="familiar" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano3.png')); ?>" alt="Plano Família">
            </div>
            <div class="servicos-content-info">
                ...
                <div class="servicos-actions">
                    <a href="<?php echo e(route('planos.familiar')); ?>" class="btn-primary-sc">Ver planos</a>
                </div>
            </div>
        </div>
        ...
        <div id="corporativo" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano4.png')); ?>" alt="Plano Corporativo">
            </div>
            <div class="servicos-content-info">
                ...
                <div class="servicos-actions">
                    <a href="<?php echo e(route('planos.corporativo')); ?>" class="btn-primary-sc">Ver planos</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="cta-bottom-section animate-on-scroll fade-up-on-scroll delay-200">
        <div class="cta-container">
            ...
            <div class="cta-actions">
                <a href="<?php echo e(route('login')); ?>" class="btn-primary-sc">Aderir a um Plano</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/planos.blade.php ENDPATH**/ ?>