<?php $__env->startSection('title', 'Perfil — Profissional'); ?>
    ...
    <div class="bg-white rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.05)] border border-outline-variant/30 overflow-hidden mb-6">
        <div class="px-6 py-4 border-b border-outline-variant/30 flex items-center gap-4">
            <?php if($user->foto_perfil): ?>
                <img src="<?php echo e(Storage::url($user->foto_perfil)); ?>" class="w-14 h-14 rounded-full object-cover">
            <?php else: ?>
            ...
            <?php endif; ?>
            <div>
                <h2 class="font-title-lg text-title-lg text-on-surface"><?php echo e($user->name); ?></h2>
                <p class="text-body-sm text-on-surface-variant"><?php echo e($user->email); ?> · <?php echo e($user->profissional?->especialidade ?? 'Profissional'); ?></p>
            </div>
        </div>
        <div class="p-6 space-y-3 text-body-sm">
            <div><span class="font-medium text-on-surface">Telefone:</span> <span class="text-on-surface-variant"><?php echo e($user->telefone ?? '—'); ?></span></div>
            <div><span class="font-medium text-on-surface">Membro desde:</span> <span class="text-on-surface-variant"><?php echo e($user->created_at->format('d/m/Y')); ?></span></div>
        </div>
    </div>
        ...
        <div class="p-6">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-on-surface-variant">Configurado em <?php echo e($user->two_factor_confirmed_at->format('d/m/Y H:i')); ?></p>
                        </div>
                    </div>
                    <form method="POST" action="<?php echo e(route('2fa.desativar')); ?>" onsubmit="return confirm('Tem a certeza que deseja desactivar o 2FA?')">
                        <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('2fa.ativar')); ?>" class="px-4 py-2 text-xs font-semibold text-on-primary bg-primary rounded-full hover:opacity-90 transition-all">
                        Configurar
                    </a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.profissional', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/profissional/perfil.blade.php ENDPATH**/ ?>