<?php $__env->startSection('title', 'Mensagens — Profissional'); ?>
...
<div class="chat-page-wrapper" style="height: calc(100vh - 7rem);">
    ...
    <div class="chat-sidebar">
        ...
        <div class="chat-list">
            <?php $__empty_1 = true; $__currentLoopData = $conversas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
                $ultimaMsg = $conversa->mensagens->first();
                $naoLidas = $conversa->nao_lidas;
            ?>
            <a href="<?php echo e(route('profissional.mensagens.index', ['conversa' => $conversa->id])); ?>"
               class="chat-list-item <?php echo e($conversaActiva && $conversaActiva->id === $conversa->id ? 'active' : ''); ?>"
               style="text-decoration: none; color: inherit;">
                <div class="chat-avatar" style="background: <?php echo e($conversaActiva && $conversaActiva->id === $conversa->id ? '' : 'linear-gradient(135deg, #005f5f, #007a7a)'); ?>;">
                    <?php echo e($conversa->iniciais ?? ($conversa->paciente?->user?->iniciais ?? '?')); ?>

                </div>
                <div class="chat-item-info">
                    <div class="chat-item-header">
                        <span class="chat-item-name"><?php echo e($conversa->contacto ?? $conversa->paciente?->user?->name ?? 'Paciente'); ?></span>
                        <span class="chat-item-time"><?php echo e($ultimaMsg ? $ultimaMsg->created_at->diffForHumans() : ''); ?></span>
                    </div>
                    <div class="chat-item-preview">
                        <?php echo e($ultimaMsg ? Str::limit($ultimaMsg->texto, 35) : 'Sem mensagens'); ?>

                        <?php if($naoLidas > 0): ?>
                            <span class="notif-badge" style="position: static; display: inline-flex; margin-left: 8px;"><?php echo e($naoLidas); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </a>
    ...
    <div class="chat-main">
        ...
        <?php $pacienteUser = $conversaActiva->paciente?->user; ?>
        <div class="chat-main-header">
            <div class="chat-main-header-info">
                <div class="chat-avatar" style="width: 48px; height: 48px; font-size: 1.1rem; background: linear-gradient(135deg, #005f5f, #007a7a);">
                    <?php echo e($conversaActiva->iniciais ?? ($pacienteUser?->iniciais ?? '?')); ?>

                </div>
                <div>
                    <h3 style="margin: 0; font-family: 'DM Sans', sans-serif; font-size: 1.1rem; color: #071e27;">
                        <?php echo e($conversaActiva->contacto ?? $pacienteUser?->name ?? 'Paciente'); ?>
        ...
        <div class="chat-messages-area">
            ...
            <?php $__currentLoopData = $conversaActiva->mensagens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mensagem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($currentDate !== $msgDate): ?>
                    <div class="chat-system-msg"><?php echo e($msgDate); ?></div>
                    <?php $currentDate = $msgDate; ?>
                <?php endif; ?>

                <div class="chat-bubble-wrapper <?php echo e($mensagem->remetente_id === Auth::id() ? 'sent' : 'received'); ?>"
                     id="msg-<?php echo e($mensagem->id); ?>">
                    <div class="chat-bubble <?php echo e($mensagem->remetente_id === Auth::id() ? 'sent' : 'received'); ?>">
                        <?php echo nl2br(e($mensagem->texto)); ?>

                        <?php if($mensagem->anexo_path): ?>
                            <?php $borderColor = $mensagem->remetente_id === Auth::id() ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.1)'; ?>
                            <div style="margin-top: 8px; border-top: 1px solid <?php echo e($borderColor); ?>; padding-top: 8px;">
                                <a href="<?php echo e(Storage::url($mensagem->anexo_path)); ?>" download
                    ...
                    <div class="chat-bubble-time"><?php echo e($mensagem->created_at->format('H:i')); ?></div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <form action="<?php echo e(route('profissional.mensagens.store')); ?>" method="POST" enctype="multipart/form-data" class="chat-input-area" style="margin: 0;">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.profissional', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/profissional/mensagens/index.blade.php ENDPATH**/ ?>