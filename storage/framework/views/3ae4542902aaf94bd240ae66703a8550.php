    ...
    <div class="servicos-content-container animate-on-scroll">
        ...
        <div id="essencial" class="servicos-tab-pane active fade-up-on-scroll delay-700">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano4.png')); ?>" alt="Plano Corporativo Essencial">
            </div>
            <div class="servicos-content-info">
                ...
                <div class="servicos-actions">
                    <a href="<?php echo e(auth()->check() ? route('plano') : route('login')); ?>" class="btn-primary-sc">Aderir Agora</a>
                </div>
            </div>
        </div>
        ...
        <div id="profissional" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano4-1.png')); ?>" alt="Plano Corporativo Profissional">
            </div>
            <div class="servicos-content-info">
        ...
        <div id="enterprise" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano4-2.png')); ?>" alt="Plano Corporativo Enterprise">
            </div>
            <div class="servicos-content-info">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/planos/corporativo.blade.php ENDPATH**/ ?>