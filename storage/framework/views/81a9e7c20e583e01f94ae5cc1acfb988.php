...
<div class="min-h-screen flex items-center justify-center bg-surface px-4 py-8">
    <div class="w-full max-w-[800px]">
        <div class="text-center mb-8">
            <img src="<?php echo e(asset('assets/logoti.png')); ?>" alt="MindCare" class="h-12 mx-auto mb-4">
        ...
        <?php if($errors->any()): ?>
            <div class="bg-red-50 text-red-700 text-sm p-3 rounded-xl mb-6 shadow-sm border border-red-100">
                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <p class="font-body-sm"><?php echo e($error); ?></p>
        ...
        <div class="tonal-card rounded-xl p-stack-lg flex flex-col gap-stack-lg mb-6">
                ...
                <div class="w-full md:w-2/3 space-y-4">
                    ...
                    <div class="mt-6 bg-surface-container-low p-4 rounded-xl border border-secondary/10">
                        ...
                        <div class="flex items-center justify-between bg-white border border-outline-variant rounded-lg p-3">
                            <code class="font-mono text-body-md text-primary font-bold break-all" id="backupCode"><?php echo e($secret); ?></code>
                        </div>
            ...
            <section class="space-y-6">
                ...
                <form method="POST" action="<?php echo e(route('2fa.ativar')); ?>" class="w-full">
                    <?php echo csrf_field(); ?>
                    <div class="max-w-md">
...
<?php endif; ?>
<?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/auth/2fa-ativar.blade.php ENDPATH**/ ?>