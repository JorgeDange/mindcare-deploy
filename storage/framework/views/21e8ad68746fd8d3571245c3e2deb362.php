    ...
    <div class="servicos-content-container animate-on-scroll">
        ...
        <div id="basico" class="servicos-tab-pane active fade-up-on-scroll delay-700">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano2.png')); ?>" alt="Plano Básico">
            </div>
        ...
        <div id="avancado" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano2-1.png')); ?>" alt="Plano Avançado">
            </div>
            <div class="servicos-content-info">
        ...
        <div id="premium" class="servicos-tab-pane">
            <div class="servicos-content-img">
                <img src="<?php echo e(asset('assets/card/plano2-2.png')); ?>" alt="Plano Premium">
            </div>
            <div class="servicos-content-info">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol16_2/infinityfree.com/if0_42474986/htdocs/resources/views/planos/particular.blade.php ENDPATH**/ ?>